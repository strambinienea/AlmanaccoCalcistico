...
database = connect(user="postgres", password="z", host="localhost", port="5432", database="almanacco_calcistico")
faker = Faker('it_IT')
...
while n < 100:
    ...
    if len(nomecognome) == 2:
        ...
        cursor.execute(sql, (calciatore["CF"], calciatore["Nome"], calciatore["Cognome"], str(random.randint(10, 99))))
        n += 1
...
cursor.execute('INSERT INTO public.Campionato ("Stagione") VALUES (\'1999/2000\')')
database.commit()

# FINE INSERT CAMPIONATO

# INIZIO INSERT PARTITE
cursor.execute('INSERT INTO public.Partita VALUES (1, 4, \'1999-01-22\', \'Juventus Stadium\', 1, 1, \'Quarti di Finale\')')
cursor.execute('INSERT INTO public.Partita VALUES (2, 5, \'1999-01-29\', \'SanSiro Stadium\', 2, 1, \'Quarti di Finale\')')
cursor.execute('INSERT INTO public.Partita VALUES (3, 7, \'1999-02-05\', \'SanSiro Stadium\', 3, 1, \'Quarti di Finale\')')
cursor.execute('INSERT INTO public.Partita VALUES (6, 8, \'1999-02-12\', \'Bentegodi Stadium\', 6, 1, \'Quarti di Finale\')')
cursor.execute('INSERT INTO public.Partita VALUES (2, 3, \'1999-02-18\', \'SanSiro Stadium\', 2, 1, \'Semifinale\')')
cursor.execute('INSERT INTO public.Partita VALUES (1, 6, \'1999-02-25\', \'Juventus Stadium\', 1, 1, \'Semifinale\')')
cursor.execute('INSERT INTO public.Partita VALUES (1, 2, \'1999-03-04\', \'Juventus Stadium\', 1, 1, \'Finale\')')
